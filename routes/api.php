...
Route::post('register',[API\User\UserController::class, 'register']); // Register 17-05-24
Route::post('registerotp',[API\User\UserController::class, 'registerotp']);
Route::post('registerprovider',[API\User\Usercontroller::class,'registerprovider']);
Route::post('user-locations', [Api\UserLocationController::class, 'store']);
 
Route::post('work-experience',[API\User\UserController::class, 'WorkExperience']);  // WorkExperience 20-05-24
Route::post('legal-document',[API\User\UserController::class,'LegalDocument']); // Legal Document 20-05-24
Route::get('category-list',[API\CategoryController::class,'getCategoryList']);  // Category List 20-05-24
Route::get('user-cat',[API\User\UserController::class,'getUserCat']);  // Users on basis of Category selected 20-05-24



Route::post('sendotp',[API\User\UserController::class,'SendOtp']);
Route::post('verifyotp',[API\User\UserController::class,'verifyOtp']);
