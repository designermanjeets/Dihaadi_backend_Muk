...
Route::get('work-experience-category',[API\CategoryController::class,'work_experience_category']);
...
Route::post('legal-document',[API\User\UserController::class, 'legal_document']);
...
Route::post('provider-list',[ API\User\UserController::class, 'providerList' ]);
Route::post('work-experience-submit',[API\User\UserController::class,'work_experience_submit']);
