<x-master-layout>
    ...
    <div class="modal-content">
     ...
     <div class="modal-body text-center">
					<a href="https://unsplash.it/1200/768.jpg?image=251" data-toggle="lightbox">
						<img id="modalImgs" src="" class="img-fluid attachmentImgCls" alt="Cinque Terre" width="50%">
					</a>
				</div>
    </div>
  </div>
  ...
  $(document).on('update_quick_action', function() {
  	...
  	$(document).on("click", '[data-toggle="lightbox"], .attachmentImgCls', function(event) {
		
		//var imgsrc = $("#document_img").attr("src");
	    var imgsrc = 	$(this).attr('src');
	
		$('#modalImgs').attr('src', imgsrc);
		});
		
			$(document).on("click", '[data-toggle="lightbox"], .attachmentImgClsadd', function(event) {
		
	//	var imgsrc = $("#document_add_img").attr("src");
		var imgsrc = 	$(this).attr('src');
